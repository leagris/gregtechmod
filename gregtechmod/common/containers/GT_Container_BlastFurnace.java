...
public class GT_Container_BlastFurnace extends GT_ContainerMetaTile_Machine {
   ...
   public void func_75142_b() {
      ...
      if(!this.mTileEntity.isClientSide() && this.mTileEntity.getMetaTileEntity() != null) {
         this.mMachine = ((GT_MetaTileEntity_BlastFurnace)this.mTileEntity.getMetaTileEntity()).mMachine;
         this.mProgress = ((GT_MetaTileEntity_BlastFurnace)this.mTileEntity.getMetaTileEntity()).getProgresstime();
         this.mMaxProgress = ((GT_MetaTileEntity_BlastFurnace)this.mTileEntity.getMetaTileEntity()).maxProgresstime();
         ...
         this.mHeatCapacity = ((GT_MetaTileEntity_BlastFurnace)this.mTileEntity.getMetaTileEntity()).mHeatCapacity;
         ...
         while(var2.hasNext()) {
            ...
            var1.func_71112_a(this, 104, this.mHeatCapacity);
         }
