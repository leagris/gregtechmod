...
public class GT_Container_Sawmill extends GT_ContainerMetaTile_Machine {
   ...
   public void func_75142_b() {
      ...
      if(!this.mTileEntity.isClientSide() && this.mTileEntity.getMetaTileEntity() != null) {
         this.mMachine = ((GT_MetaTileEntity_Sawmill)this.mTileEntity.getMetaTileEntity()).mMachine;
         this.mWaterAmount = ((GT_MetaTileEntity_Sawmill)this.mTileEntity.getMetaTileEntity()).mWaterAmount;
         this.mProgress = ((GT_MetaTileEntity_Sawmill)this.mTileEntity.getMetaTileEntity()).getProgresstime();
         this.mMaxProgress = ((GT_MetaTileEntity_Sawmill)this.mTileEntity.getMetaTileEntity()).maxProgresstime();
