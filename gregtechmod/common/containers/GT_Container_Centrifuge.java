...
public class GT_Container_Centrifuge extends GT_ContainerMetaTile_Machine {
   ...
   public void addSlots(InventoryPlayer aInventoryPlayer) {
      ...
      this.func_75146_a(new Slot(this.mTileEntity, 1, 50, 5));
      this.func_75146_a(new GT_Slot_Output(this.mTileEntity, 2, 80, 5));
      this.func_75146_a(new GT_Slot_Output(this.mTileEntity, 3, 110, 35));
      this.func_75146_a(new GT_Slot_Output(this.mTileEntity, 4, 80, 65));
      this.func_75146_a(new GT_Slot_Output(this.mTileEntity, 5, 50, 35));
      this.func_75146_a(new GT_Slot_Holo(this.mTileEntity, 6, 110, 65, false, false, 64));
   }

   public void func_75142_b() {
      super.func_75142_b();
      if(!this.mTileEntity.isClientSide() && this.mTileEntity.getMetaTileEntity() != null) {
         this.mProgress = ((GT_MetaTileEntity_Centrifuge)this.mTileEntity.getMetaTileEntity()).getProgresstime();
         this.mMaxProgress = ((GT_MetaTileEntity_Centrifuge)this.mTileEntity.getMetaTileEntity()).maxProgresstime();
