...
public class GT_Container_ImplosionCompressor extends GT_ContainerMetaTile_Machine {
   ...
   public void func_75142_b() {
      ...
      if(!this.mTileEntity.isClientSide() && this.mTileEntity.getMetaTileEntity() != null) {
         this.mMachine = ((GT_MetaTileEntity_ImplosionCompressor)this.mTileEntity.getMetaTileEntity()).mMachine;
         this.mProgress = ((GT_MetaTileEntity_ImplosionCompressor)this.mTileEntity.getMetaTileEntity()).getProgresstime();
         this.mMaxProgress = ((GT_MetaTileEntity_ImplosionCompressor)this.mTileEntity.getMetaTileEntity()).maxProgresstime();
