...
public class GT_Container_BronzeBoiler extends GT_ContainerMetaTile_Machine {
   ...
   public void func_75142_b() {
      ...
      if(!this.mTileEntity.isClientSide() && this.mTileEntity.getMetaTileEntity() != null) {
         this.mTemperature = ((GT_MetaTileEntity_Boiler_Bronze)this.mTileEntity.getMetaTileEntity()).mTemperature;
         this.mProcessingEnergy = ((GT_MetaTileEntity_Boiler_Bronze)this.mTileEntity.getMetaTileEntity()).mProcessingEnergy;
         this.mSteamAmount = ((GT_MetaTileEntity_Boiler_Bronze)this.mTileEntity.getMetaTileEntity()).mSteam == null?0:((GT_MetaTileEntity_Boiler_Bronze)this.mTileEntity.getMetaTileEntity()).mSteam.amount;
         this.mWaterAmount = ((GT_MetaTileEntity_Boiler_Bronze)this.mTileEntity.getMetaTileEntity()).mFluid == null?0:((GT_MetaTileEntity_Boiler_Bronze)this.mTileEntity.getMetaTileEntity()).mFluid.amount;
         this.mTemperature = Math.min(54, Math.max(0, this.mTemperature * 54 / 490));
         this.mSteamAmount = Math.min(54, Math.max(0, this.mSteamAmount * 54 / 15900));
