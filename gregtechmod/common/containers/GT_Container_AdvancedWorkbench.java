            ...
            try {
               ...
               if(aSlotIndex == 32) {
                  if(aMouseclick == 0 && aShifthold == 1) {
                     ((GT_MetaTileEntity_AdvancedCraftingTable)this.mTileEntity.getMetaTileEntity()).setBluePrint((ItemStack)null);
                     return null;
                  }
               } else {
                  if(aSlotIndex == 33) {
                     ...
                     if(tCraftedStack != null) {
                        ...
                        if(aShifthold != 1) {
                           if(aMouseclick == 0) {
                              if(((GT_MetaTileEntity_AdvancedCraftingTable)this.mTileEntity.getMetaTileEntity()).canDoCraftingOutput()) {
                                 aPlayer.field_71071_by.func_70437_b(((GT_MetaTileEntity_AdvancedCraftingTable)this.mTileEntity.getMetaTileEntity()).consumeMaterials(aPlayer, aPlayer.field_71071_by.func_70445_o()));
                              }
                           ...
                           while(true) {
                              if(var11 < tCraftedStack.func_77976_d() / tCraftedStack.field_77994_a && ((GT_MetaTileEntity_AdvancedCraftingTable)this.mTileEntity.getMetaTileEntity()).canDoCraftingOutput()) {
                                 if(GT_Utility.areStacksEqual(tStack2 = ((GT_MetaTileEntity_AdvancedCraftingTable)this.mTileEntity.getMetaTileEntity()).getCraftingOutput(), tCraftedStack) && (e == null || e.field_77994_a == tStack2.field_77994_a)) {
                                    aPlayer.field_71071_by.func_70437_b(((GT_MetaTileEntity_AdvancedCraftingTable)this.mTileEntity.getMetaTileEntity()).consumeMaterials(aPlayer, aPlayer.field_71071_by.func_70445_o()));
                                    ++var11;
                                    continue;
                                 }
                        ...
                        while(i < aPlayer.field_71071_by.field_70462_a.length) {
                           ...
                           while(true) {
                              if(j < tCraftedStack.func_77976_d() / tCraftedStack.field_77994_a && ((GT_MetaTileEntity_AdvancedCraftingTable)this.mTileEntity.getMetaTileEntity()).canDoCraftingOutput()) {
                                 if(GT_Utility.areStacksEqual(tStack2 = ((GT_MetaTileEntity_AdvancedCraftingTable)this.mTileEntity.getMetaTileEntity()).getCraftingOutput(), tCraftedStack) && (e == null || e.field_77994_a == tStack2.field_77994_a)) {
                                    aPlayer.field_71071_by.field_70462_a[i] = ((GT_MetaTileEntity_AdvancedCraftingTable)this.mTileEntity.getMetaTileEntity()).consumeMaterials(aPlayer, aPlayer.field_71071_by.field_70462_a[i]);
                                    ++j;
                                    continue;
                                 }
