...
public class GT_MetaTileEntity_Boiler_Steel extends GT_MetaTileEntity_BasicTank {
   ...
   public void onRightclick(EntityPlayer aPlayer) {
      if(aPlayer != null) {
         if(GT_Utility.areStacksEqual(aPlayer.func_71045_bC(), new ItemStack(Item.field_77786_ax, 1))) {
            ...
            this.getBaseMetaTileEntity().openGUI(aPlayer, 171);
         }
      }
   ...
   public void onPostTick() {
      if(this.getBaseMetaTileEntity().isServerSide()) {
         ...
         if(this.getBaseMetaTileEntity().getTimer() % 10L == 0L) {
         ...
         if(this.mTemperature < 1000 && this.mProcessingEnergy > 0 && this.getBaseMetaTileEntity().getTimer() % 12L == 0L) {
   ...
   public int getTextureIndex(byte aSide, byte aFacing, boolean aActive, boolean aRedstone) {
      return aSide == 0?351:(aSide == 1?350:(aSide == aFacing?(aActive?353:352):349));
   }
