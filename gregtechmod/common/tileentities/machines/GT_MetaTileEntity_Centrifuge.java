...
public class GT_MetaTileEntity_Centrifuge extends GT_MetaTileEntity_BasicTank {
   ...
   public GT_MetaTileEntity_Centrifuge(int aID, String aName, String aNameRegional) {
   ...
   public void onRightclick(EntityPlayer aPlayer) {
      this.getBaseMetaTileEntity().openGUI(aPlayer, 146);
   }
   ...
   public void onPostTick() {
      if(this.getBaseMetaTileEntity().isServerSide()) {
         if(this.getBaseMetaTileEntity().getOverclockerUpgradeCount() >= 2) {
            this.mSpeed = 2;
         } else if(this.getBaseMetaTileEntity().getOverclockerUpgradeCount() == 1) {
            this.mSpeed = 1;
         } else {
            this.mSpeed = 0;
         }
   ...
   private boolean checkRecipe() {
      if(this.mInventory[0] != null) {
         GT_Recipe tStack = GT_Recipe.findEqualRecipe(false, false, GT_Recipe.sCentrifugeRecipes, new ItemStack[]{this.mInventory[0], this.mInventory[1]});
      ...
      if(this.mFluid != null) {
         ...
         if(tStack1 != null && tFluid != null) {
            ...
            GT_Recipe tRecipe = GT_Recipe.findEqualRecipe(false, false, GT_Recipe.sCentrifugeRecipes, new ItemStack[]{tStack1, this.mInventory[1]});
   ...
   public int getTextureIndex(byte aSide, byte aFacing, boolean aActive, boolean aRedstone) {
      return aSide == 0?32:(aSide == 1?(aActive?(this.mSpeed == 2?44:(this.mSpeed == 1?43:42)):41):(aActive?(this.mSpeed == 2?28:(this.mSpeed == 1?27:26)):25));
   }
   ...
   public boolean allowPutStack(int aIndex, byte aSide, ItemStack aStack) {
      return !GT_Items.Cell_Empty.isStackEqual(aStack) && !GT_Items.IC2_Fuel_Can_Empty.isStackEqual(aStack)?aIndex == 0:aIndex == 1;
   }
