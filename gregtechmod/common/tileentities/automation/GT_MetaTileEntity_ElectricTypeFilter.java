...
public class GT_MetaTileEntity_ElectricTypeFilter extends GT_MetaTileEntity_ElectricBufferSmall {
   ...
   public GT_MetaTileEntity_ElectricTypeFilter(int aID, String aName, String aNameRegional) {
   ...
   public void onPreTick() {
      if(this.getBaseMetaTileEntity().isServerSide() && this.getBaseMetaTileEntity().getTimer() % 8L == 0L) {
         if(this.mPrefix.mPrefixedItems.isEmpty()) {
            ...
            this.mInventory[9].func_82834_c(this.mPrefix.toString());
         }
      }
   ...
   public boolean allowPutStack(int aIndex, byte aSide, ItemStack aStack) {
      return aSide != this.getBaseMetaTileEntity().getBackFacing() && (this.bNBTAllowed || !aStack.func_77942_o()) && this.mPrefix.contains(aStack) != this.bInvertFilter;
   }
