...
public class GT_MetaTileEntity_Translocator extends MetaTileEntity {
   ...
   public GT_MetaTileEntity_Translocator(int aID, String aName, String aNameRegional) {
   ...
   public void onRightclick(EntityPlayer aPlayer) {
      this.getBaseMetaTileEntity().openGUI(aPlayer, 101);
   }
   ...
   public void onPostTick() {
      if(this.getBaseMetaTileEntity().isAllowedToWork() && this.getBaseMetaTileEntity().isServerSide() && this.getBaseMetaTileEntity().isUniversalEnergyStored(2000) && (this.getBaseMetaTileEntity().hasWorkJustBeenEnabled() || this.getBaseMetaTileEntity().getTimer() % (long)(197 - this.getBaseMetaTileEntity().getOverclockerUpgradeCount() * 49) == 0L || this.getBaseMetaTileEntity().getTimer() % 5L == 0L && this.mSuccess > 0 || this.mSuccess >= 20)) {
         ...
         tCost = (this.getBaseMetaTileEntity().getOverclockerUpgradeCount() + 1) * GT_Utility.moveOneItemStack(this.getBaseMetaTileEntity().getTileEntityAtSide(this.getBaseMetaTileEntity().getFrontFacing()), this.getBaseMetaTileEntity().getTileEntityAtSide(this.getBaseMetaTileEntity().getBackFacing()), this.getBaseMetaTileEntity().getBackFacing(), this.getBaseMetaTileEntity().getFrontFacing(), tList, this.bInvertFilter, (byte)64, (byte)1, (byte)64, (byte)1) * 2 * (this.mInventory[0] == null && this.mInventory[1] == null && this.mInventory[2] == null && this.mInventory[3] == null && this.mInventory[4] == null && this.mInventory[5] == null && this.mInventory[6] == null && this.mInventory[7] == null && this.mInventory[8] == null?1:2);
         if(tCost > 0) {
