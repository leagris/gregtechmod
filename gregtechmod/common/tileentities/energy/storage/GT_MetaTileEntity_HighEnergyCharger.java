...
public class GT_MetaTileEntity_HighEnergyCharger extends GT_MetaTileEntity_ChargerBox {
   ...
   public GT_MetaTileEntity_HighEnergyCharger(int aID, String aName, String aNameRegional) {
   ...
   public void onPreTick() {
      ...
      if(this.getBaseMetaTileEntity().isServerSide()) {
         this.getBaseMetaTileEntity().setActive(GT_ModHandler.isElectricItem(this.mInventory[0], (byte)7) && GT_ModHandler.canUseElectricItem(this.mInventory[0], 1));
      }
