...
public class GT_Debug_Item extends GT_Generic_Item implements IElectricItem {
   ...
   public GT_Debug_Item(int aID, String aUnlocalized, String aEnglish) {
   ...
   public void func_77633_a(int var1, CreativeTabs var2, List var3) {
      ...
      var3.add(tCharged);
      Iterator i$ = GregTech_API.sBookList.values().iterator();
   ...
   public boolean onItemUseFirst(ItemStack aStack, EntityPlayer aPlayer, World aWorld, int aX, int aY, int aZ, int aSide, float aClickX, float aClickY, float aClickZ) {
      if(aWorld.field_72995_K) {
         ...
         return false;
      } else if(aPlayer instanceof EntityPlayerMP && GT_ModHandler.canUseElectricItem(aStack, 25000)) {
