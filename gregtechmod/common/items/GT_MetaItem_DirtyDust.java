...
public class GT_MetaItem_DirtyDust extends GT_MetaItem_Abstract {
   ...
   public static ItemStack addItem(int aMeta, String aName, Materials aMaterial, boolean aGlow) {
      GT_LanguageManager.addStringLocalization(instance.func_77658_a() + "." + aMeta + ".name", "Dirty Pile of " + aName);
      instance.mToolTipList[aMeta] = aMaterial.getToolTip(OrePrefixes.dustImpure.mMaterialAmount / 3628800L);
      instance.mGlowList[aMeta] = aGlow;
      instance.mStackList[aMeta] = new ItemStack(instance, 1, aMeta);
      GT_OreDictUnificator.set(OrePrefixes.dustImpure, aMaterial, instance.getUnunifiedStack(aMeta, 1));
