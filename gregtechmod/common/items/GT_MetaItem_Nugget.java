...
public class GT_MetaItem_Nugget extends GT_MetaItem_Abstract {
   ...
   public static ItemStack addItem(int aMeta, Materials aMaterial, boolean aGlow) {
      GT_LanguageManager.addStringLocalization(instance.func_77658_a() + "." + aMeta + ".name", aMaterial + " Nugget");
      instance.mToolTipList[aMeta] = aMaterial.getToolTip(OrePrefixes.nugget.mMaterialAmount / 3628800L);
      instance.mGlowList[aMeta] = aGlow;
      instance.mStackList[aMeta] = new ItemStack(instance, 1, aMeta);
      GT_OreDictUnificator.set(OrePrefixes.nugget, aMaterial, instance.getUnunifiedStack(aMeta, 1));
