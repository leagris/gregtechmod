...
public class GT_GUIContainer_TradeOMat_Inventory_Money extends GT_GUIContainerMetaTile_Machine {
   ...
   public GT_GUIContainer_TradeOMat_Inventory_Money(InventoryPlayer aInventoryPlayer, IGregTechTileEntity aTileEntity) {
   ...
   protected void func_74189_g(int par1, int par2) {
      this.field_73886_k.func_78276_b("Your Income", 8, 5, 4210752);
   }
