...
public class GT_GUIContainer_SteelBoiler extends GT_GUIContainerMetaTile_Machine {
   ...
   public GT_GUIContainer_SteelBoiler(InventoryPlayer aInventoryPlayer, IGregTechTileEntity aTileEntity) {
      super(new GT_Container_SteelBoiler(aInventoryPlayer, aTileEntity), "gregtech_addon:textures/gui/SteelBoiler.png");
   }

   protected void func_74189_g(int par1, int par2) {
      this.field_73886_k.func_78276_b("High Pressure Coal Boiler", 8, 4, 4210752);
   }
   ...
   protected void func_74185_a(float par1, int par2, int par3) {
      ...
      if(this.mContainer != null) {
         int tScale = ((GT_Container_SteelBoiler)this.mContainer).mSteamAmount;
         if(tScale > 0) {
            this.func_73729_b(x + 70, y + 25 + 54 - tScale, 194, 54 - tScale, 10, tScale);
         }

         tScale = ((GT_Container_SteelBoiler)this.mContainer).mWaterAmount;
         if(tScale > 0) {
            this.func_73729_b(x + 83, y + 25 + 54 - tScale, 204, 54 - tScale, 10, tScale);
         }

         tScale = ((GT_Container_SteelBoiler)this.mContainer).mTemperature;
         if(tScale > 0) {
            this.func_73729_b(x + 96, y + 25 + 54 - tScale, 214, 54 - tScale, 10, tScale);
         }

         tScale = ((GT_Container_SteelBoiler)this.mContainer).mProcessingEnergy;
         if(tScale > 0) {
