...
public class GT_GUIContainer_AdvancedPump extends GT_GUIContainerMetaTile_Machine {
   ...
   public GT_GUIContainer_AdvancedPump(InventoryPlayer aInventoryPlayer, IGregTechTileEntity aTileEntity) {
      super(new GT_Container_AdvancedPump(aInventoryPlayer, aTileEntity), "gregtech_addon:textures/gui/AdvPump.png");
   }
   ...
   protected void func_74189_g(int par1, int par2) {
      ...
      this.field_73886_k.func_78276_b("Advanced Pump", 8, 6, 4210752);
      this.field_73886_k.func_78276_b("", 10, 20, 16448255);
   }
