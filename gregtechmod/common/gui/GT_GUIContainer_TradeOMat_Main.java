...
public class GT_GUIContainer_TradeOMat_Main extends GT_GUIContainerMetaTile_Machine {
   ...
   public GT_GUIContainer_TradeOMat_Main(InventoryPlayer aInventoryPlayer, IGregTechTileEntity aTileEntity) {
   ...
   protected void func_74189_g(int par1, int par2) {
      this.field_73886_k.func_78276_b("Trade-O-Mat", 8, 5, 4210752);
   }
