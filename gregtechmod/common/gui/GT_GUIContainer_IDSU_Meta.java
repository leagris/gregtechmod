...
public class GT_GUIContainer_IDSU_Meta extends GT_GUIContainerMetaTile_Machine {
   ...
   public GT_GUIContainer_IDSU_Meta(InventoryPlayer aInventoryPlayer, IGregTechTileEntity aTileEntity) {
      super(new GT_Container_IDSU_Meta(aInventoryPlayer, aTileEntity), "gregtech_addon:textures/gui/IDSU.png");
   }

   protected void func_74189_g(int par1, int par2) {
      this.field_73886_k.func_78276_b("I.D.S.U.", 11, 8, 16448255);
      if(this.mContainer != null) {
         this.field_73886_k.func_78276_b("ID: " + ((GT_Container_IDSU_Meta)this.mContainer).mPlayerHash, 11, 16, 16448255);
         this.field_73886_k.func_78276_b("EU: " + GT_Utility.parseNumberToString(this.mContainer.mEnergy), 11, 24, 16448255);
         this.field_73886_k.func_78276_b("MAX: " + GT_Utility.parseNumberToString(this.mContainer.mStorage), 11, 32, 16448255);
         this.field_73886_k.func_78276_b("MAX EU/t IN: " + GT_Utility.parseNumberToString(this.mContainer.mInput), 11, 40, 16448255);
