...
public class GT_GUIContainer_RockBreaker extends GT_GUIContainerMetaTile_Machine {
   ...
   public GT_GUIContainer_RockBreaker(InventoryPlayer aInventoryPlayer, IGregTechTileEntity aTileEntity) {
      super(new GT_Container_RockBreaker(aInventoryPlayer, aTileEntity), "gregtech_addon:textures/gui/RockBreaker.png");
   }

   protected void func_74189_g(int par1, int par2) {
      this.field_73886_k.func_78276_b("Rock Breaker", 5, 5, 4210752);
   }
