...
public class GT_GUIContainer_ElectricBufferAdvanced extends GT_GUIContainerMetaTile_Machine {
   ...
   public GT_GUIContainer_ElectricBufferAdvanced(InventoryPlayer aInventoryPlayer, IGregTechTileEntity aTileEntity) {
      super(new GT_Container_ElectricBufferAdvanced(aInventoryPlayer, aTileEntity), "gregtech_addon:textures/gui/ElectricBufferAdvanced.png");
   }

   protected void func_74189_g(int par1, int par2) {
      this.field_73886_k.func_78276_b("" + ((GT_Container_ElectricBufferAdvanced)this.mContainer).mTargetSlot, 100, 65, 16448255);
   }
