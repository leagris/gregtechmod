...
public class GT_GUIContainer_ThermalGenerator extends GT_GUIContainerMetaTile_Machine {
   ...
   public GT_GUIContainer_ThermalGenerator(InventoryPlayer aInventoryPlayer, IGregTechTileEntity aTileEntity) {
   ...
   protected void func_74189_g(int par1, int par2) {
      ...
      this.field_73886_k.func_78276_b("Thermal Generator", 8, 6, 4210752);
