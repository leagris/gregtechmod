...
public class GT_GUIContainer_Safe extends GT_GUIContainerMetaTile_Machine {
   ...
   public GT_GUIContainer_Safe(InventoryPlayer aInventoryPlayer, IGregTechTileEntity aTileEntity) {
      super(new GT_Container_Safe(aInventoryPlayer, aTileEntity), "gregtech_addon:textures/gui/Safe.png");
   }
