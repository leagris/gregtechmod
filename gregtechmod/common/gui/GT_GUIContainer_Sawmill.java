...
public class GT_GUIContainer_Sawmill extends GT_GUIContainerMetaTile_Machine {
   ...
   public GT_GUIContainer_Sawmill(InventoryPlayer aInventoryPlayer, IGregTechTileEntity aTileEntity) {
      super(new GT_Container_Sawmill(aInventoryPlayer, aTileEntity), "gregtech_addon:textures/gui/Sawmill.png");
   }

   protected void func_74189_g(int par1, int par2) {
      this.field_73886_k.func_78276_b("Industrial Sawmill", 8, 4, 4210752);
