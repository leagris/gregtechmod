...
public class GT_GUIContainer_ChemicalReactor extends GT_GUIContainerMetaTile_Machine {
   ...
   public GT_GUIContainer_ChemicalReactor(InventoryPlayer aInventoryPlayer, IGregTechTileEntity aTileEntity) {
      super(new GT_Container_ChemicalReactor(aInventoryPlayer, aTileEntity), "gregtech_addon:textures/gui/ChemicalReactor.png");
   }

   protected void func_74189_g(int par1, int par2) {
      this.field_73886_k.func_78276_b("Chemical Reactor", 8, 4, 4210752);
   ...
   protected void func_74185_a(float par1, int par2, int par3) {
      ...
      if(this.mContainer != null && this.mContainer.mProgressTime > 0) {
         ...
         this.func_73729_b(x + 73, y + 34, 183, 34, 30, tScale);
      }
