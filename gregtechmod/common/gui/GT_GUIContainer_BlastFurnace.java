...
public class GT_GUIContainer_BlastFurnace extends GT_GUIContainerMetaTile_Machine {
   ...
   public GT_GUIContainer_BlastFurnace(InventoryPlayer aInventoryPlayer, IGregTechTileEntity aTileEntity) {
      super(new GT_Container_BlastFurnace(aInventoryPlayer, aTileEntity), "gregtech_addon:textures/gui/Blast.png");
   }

   protected void func_74189_g(int par1, int par2) {
      this.field_73886_k.func_78276_b("Industrial Blast Furnace", 8, 4, 4210752);
      if(((GT_Container_BlastFurnace)this.mContainer).mMachine) {
         this.field_73886_k.func_78276_b("Heat Capacity: " + ((GT_Container_BlastFurnace)this.mContainer).mHeatCapacity + " K", 8, this.field_74195_c - 103, 4210752);
      } else {
