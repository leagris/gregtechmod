...
public class ProcessingBlock implements IOreRecipeRegistrator {
   ...
   public void registerOre(OrePrefixes aPrefix, Materials aMaterial, String aOreDictName, String aModName, ItemStack aStack) {
      GregTech_API.sRecipeAdder.addCutterRecipe(GT_Utility.copyAmount(1L, new Object[]{aStack}), GT_OreDictUnificator.get(OrePrefixes.plate, (Object)aMaterial, 9L), Math.max(aMaterial.getMass() * 10, 1), 30);
      ...
      if(tStack1 != null) {
         tStack1.field_77994_a = 9;
      }

      if(tStack2 != null) {
         tStack2.field_77994_a = 9;
      }
      ...
      if(aStack.func_77973_b() instanceof ItemBlock && GT_Mod.sBlockStackSize < aStack.func_77973_b().func_77639_j()) {
