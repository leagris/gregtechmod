...
public class ProcessingDust implements IOreRecipeRegistrator {
   ...
   public void registerOre(OrePrefixes aPrefix, Materials aMaterial, String aOreDictName, String aModName, ItemStack aStack) {
      ...
      if(aMaterial.mMaterialList.size() > 0 && (aMaterial.mExtraData & 3) != 0) {
         ...
         while(i$.hasNext()) {
            MaterialStack tMat = (MaterialStack)i$.next();
            if(tMat.mAmount > 0L) {
               ...
               if(tItemAmount + tMat.mAmount * 3628800L <= (long)aStack.func_77976_d() * aMaterial.getDensity()) {
                  tItemAmount += tMat.mAmount * 3628800L;
                  if(tStack != null) {
                     for(tStack.field_77994_a = (int)((long)tStack.field_77994_a * tDensityMultiplier); tStack.field_77994_a > 64 && tList.size() < 4 && tCapsuleCount + (long)(GT_ModHandler.getCapsuleCellContainerCount(tStack) * 64) <= 64L; tStack.field_77994_a -= 64) {
                     ...
                     if(tStack.field_77994_a > 0 && tList.size() < 4 && tCapsuleCount + (long)GT_ModHandler.getCapsuleCellContainerCountMultipliedWithStackSize(new ItemStack[]{tStack}) <= 64L) {
      ...
      switch(ProcessingDust.NamelessClass145070512.$SwitchMap$gregtechmod$api$enums$Materials[aMaterial.ordinal()]) {
      case 1:
      default:
         break;
      case 2:
         GT_ModHandler.addSmeltingRecipe(GT_Utility.copyAmount(1L, new Object[]{aStack}), new ItemStack(Item.field_77684_U, 1, 0));
         break;
      case 3:
         GregTech_API.sRecipeAdder.addCannerRecipe(aStack, new ItemStack(Item.field_77786_ax, 1), new ItemStack(Item.field_77771_aG, 1), (ItemStack)null, 100, 1);
         break;
      case 4:
   ...
   // $FF: synthetic class
   static class NamelessClass145070512 {
