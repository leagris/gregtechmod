...
public class ProcessingOre implements IOreRecipeRegistrator {
   ...
   public void registerOre(OrePrefixes aPrefix, Materials aMaterial, String aOreDictName, String aModName, ItemStack aStack) {
      if(aStack.func_77973_b() instanceof ItemBlock && aStack.func_77973_b().func_77639_j() > GT_Mod.sOreStackSize) {
         aStack.func_77973_b().func_77625_d(GT_Mod.sOreStackSize);
      }

      if(aMaterial == Materials.Oilsands) {
         GregTech_API.sRecipeAdder.addCentrifugeRecipe(GT_Utility.copyAmount(2L, new Object[]{aStack}), 1, GT_OreDictUnificator.get(OrePrefixes.cell, (Object)Materials.Oil, aPrefix != OrePrefixes.oreNether && aPrefix != OrePrefixes.oreDense?1L:2L), new ItemStack(Block.field_71939_E, 1, 0), (ItemStack)null, (ItemStack)null, aPrefix != OrePrefixes.oreNether && aPrefix != OrePrefixes.oreDense?1000:2000);
      } else {
   ...
   private static boolean registerStandardOreRecipes(OrePrefixes aPrefix, Materials aMaterial, ItemStack aOreStack, int aMultiplier) {
      if(aOreStack != null && aMaterial != null) {
         GT_ModHandler.addValuableOre(aOreStack.field_77993_c, aOreStack.func_77960_j(), aMaterial.mOreValue);
         ...
         Iterator i$ = aMaterial.mOreByProducts.iterator();

         while(i$.hasNext()) {
            Materials tMat = (Materials)i$.next();
         ...
         if(tSmeltInto != null) {
            if(!aMaterial.mBlastFurnaceRequired && !aMaterial.mDirectSmelting.mBlastFurnaceRequired) {
               GT_ModHandler.addInductionSmelterRecipe(aOreStack, new ItemStack(Block.field_71939_E, 1), GT_Utility.mul((long)(aMultiplier * (aMaterial.contains(SubTag.INDUCTIONSMELTING_LOW_OUTPUT)?1:2) * aMaterial.mSmeltingMultiplier), new Object[]{tSmeltInto}), GT_Items.TE_Slag_Rich.get(1L, new Object[0]), 300 * aMultiplier, 10 * aMultiplier);
         ...
         if(tCrushed != null) {
            if(GregTech_API.sRecipeFile.get(GT_ConfigCategories.Tools.hammercrushing, aPrefix.get(aMaterial), true)) {
               GT_ModHandler.addCraftingRecipe(GT_Utility.copy(new Object[]{tCrushed}), new Object[]{"T", "O", Character.valueOf('T'), GT_ToolDictNames.craftingToolHardHammer, Character.valueOf('O'), aPrefix.get(aMaterial)});
            }

            GregTech_API.sRecipeAdder.addForgeHammerRecipe(aOreStack, GT_Utility.copy(new Object[]{tCrushed}), 16, 10);
            GT_ModHandler.addPulverisationRecipe(aOreStack, GT_Utility.mul(2L, new Object[]{tCrushed}), tMaterial.contains(SubTag.PULVERIZING_CINNABAR)?GT_OreDictUnificator.get(OrePrefixes.crystal, Materials.Cinnabar, GT_Utility.copyAmount(1L, new Object[]{tPrimaryByProduct}), 1L):GT_Utility.copyAmount(1L, new Object[]{tPrimaryByProduct}), tPrimaryByProduct == null?0:tPrimaryByProduct.field_77994_a * 10 * aMultiplier * aMaterial.mByProductMultiplier, true);
            if(tGem != null) {
