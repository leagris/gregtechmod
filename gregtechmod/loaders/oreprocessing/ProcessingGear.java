...
public class ProcessingGear implements IOreRecipeRegistrator {
   ...
   public void registerOre(OrePrefixes aPrefix, Materials aMaterial, String aOreDictName, String aModName, ItemStack aStack) {
      ...
      switch(ProcessingGear.NamelessClass491481957.$SwitchMap$gregtechmod$api$enums$Materials[aMaterial.ordinal()]) {
      case 1:
         ...
         break;
      case 2:
         GT_ModHandler.addCraftingRecipe(GT_Utility.copyAmount(1L, new Object[]{aStack}), new Object[]{"SPS", "PTP", "SPS", Character.valueOf('P'), "stoneSmooth", Character.valueOf('S'), new ItemStack(Block.field_72034_aR, 1, 0), Character.valueOf('T'), GT_ToolDictNames.craftingToolFile});
         break;
      default:
   ...
   // $FF: synthetic class
   static class NamelessClass491481957 {
