...
public class GT_DictRegistratorPostItem implements Runnable {
   ...
   public void run() {
      GT_Log.out.println("GT_Mod: Registering other Stuff to the OreDict.");
      ...
      GT_OreDictUnificator.registerOre(OrePrefixes.battery, Materials.Lithium, GT_Items.Energy_Lithium.getWildcard(1L, new Object[0]));
      GT_OreDictUnificator.registerOre(OrePrefixes.battery, Materials.Lithium, GT_Items.Energy_Lithium_Empty.getWildcard(1L, new Object[0]));
      GT_OreDictUnificator.registerOre(OrePrefixes.circuit, Materials.Ultimate, GT_Items.Tool_DataOrb.getWildcard(1L, new Object[0]));
      GT_OreDictUnificator.registerOre(OrePrefixes.circuit, Materials.Basic, GT_Items.Circuit_Integrated.getWildcard(1L, new Object[0]));
      ...
      GT_OreDictUnificator.registerOre(GT_OreDictNames.crafting600kEUPack, GT_Items.Armor_LithiumPack.getWildcard(1L, new Object[0]));
      ...
      GT_OreDictUnificator.registerOre(GT_OreDictNames.crafting100kkEUPack, GT_Items.Armor_LapotronicPack.getWildcard(1L, new Object[0]));
      ...
      GT_OreDictUnificator.registerOre(GT_OreDictNames.crafting60kCoolantStore, GT_Items.Reactor_Coolant_He_1.getWildcard(1L, new Object[0]));
      GT_OreDictUnificator.registerOre(GT_OreDictNames.crafting60kCoolantStore, GT_Items.Reactor_Coolant_NaK_1.getWildcard(1L, new Object[0]));
      GT_OreDictUnificator.registerOre(GT_OreDictNames.crafting180kCoolantStore, GT_Items.Reactor_Coolant_He_3.getWildcard(1L, new Object[0]));
      GT_OreDictUnificator.registerOre(GT_OreDictNames.crafting180kCoolantStore, GT_Items.Reactor_Coolant_NaK_3.getWildcard(1L, new Object[0]));
      GT_OreDictUnificator.registerOre(GT_OreDictNames.crafting360kCoolantStore, GT_Items.Reactor_Coolant_He_6.getWildcard(1L, new Object[0]));
      GT_OreDictUnificator.registerOre(GT_OreDictNames.crafting360kCoolantStore, GT_Items.Reactor_Coolant_NaK_6.getWildcard(1L, new Object[0]));
      ...
      GT_OreDictUnificator.registerOre(GT_OreDictNames.craftingRedstoneTorch, new ItemStack(Block.field_72049_aP, 1, 32767));
      GT_OreDictUnificator.registerOre(GT_OreDictNames.craftingRedstoneTorch, new ItemStack(Block.field_72035_aQ, 1, 32767));
      ...
      GT_OreDictUnificator.registerOre(GT_OreDictNames.craftingWorkBench, new ItemStack(Block.field_72060_ay, 1));
      GT_OreDictUnificator.registerOre(GT_OreDictNames.craftingWorkBench, new ItemStack(GregTech_API.sBlockList[1], 1, 16));
      GT_OreDictUnificator.registerOre(GT_OreDictNames.craftingPiston, new ItemStack(Block.field_71963_Z, 1, 32767));
      GT_OreDictUnificator.registerOre(GT_OreDictNames.craftingPiston, new ItemStack(Block.field_71956_V, 1, 32767));
      ...
      GT_OreDictUnificator.registerOre(GT_OreDictNames.craftingChest, new ItemStack(Block.field_72077_au, 1, 32767));
      GT_OreDictUnificator.registerOre(GT_OreDictNames.craftingChest, new ItemStack(Block.field_94347_ck, 1, 32767));
      GT_OreDictUnificator.registerOre(GT_OreDictNames.craftingFurnace, new ItemStack(Block.field_72051_aB, 1, 32767));
      GT_OreDictUnificator.registerOre(GT_OreDictNames.craftingFurnace, new ItemStack(Block.field_72052_aC, 1, 32767));
      ...
      GT_OreDictUnificator.registerOre("paperEmpty", new ItemStack(Item.field_77759_aK, 1));
      GT_OreDictUnificator.registerOre("paperMap", new ItemStack(Item.field_82801_bO, 1));
      GT_OreDictUnificator.registerOre("paperMap", new ItemStack(Item.field_77744_bd, 1));
      GT_OreDictUnificator.registerOre("bookEmpty", new ItemStack(Item.field_77760_aL, 1));
      GT_OreDictUnificator.registerOre("bookWritable", new ItemStack(Item.field_77821_bF, 1));
      GT_OreDictUnificator.registerOre("bookWritten", new ItemStack(Item.field_77823_bG, 1));
      GT_OreDictUnificator.registerOre("bookEnchanted", new ItemStack(Item.field_92105_bW, 1));
   }
}
