...
public class GT_Worldgen_Stone_Ore_SingleBlock extends GT_Worldgen_Ore {
   ...
   private final int[] mOreIDs;
   private final int[] mOreMetas;
   private final int[] mOreChances;
   ...
   public GT_Worldgen_Stone_Ore_SingleBlock(String aName, boolean aDefault, int aBlockID, int aBlockMeta, int aDimensionType, int aAmount, int aSize, int aProbability, int aMinY, int aMaxY, Collection<String> aBiomeList, boolean aAllowToGenerateinVoid, int[] aOreIDs, int[] aOreMetas, int[] aOreChances) {
      ...
      this.mOreIDs = aOreIDs;
      this.mOreMetas = aOreMetas;
      this.mOreChances = aOreChances;
   }
                        ...
                        for(int var41 = var33; var41 <= var36; ++var41) {
                           ...
                           if(var39 * var39 + var42 * var42 < 1.0D) {
                              ...
                              while(var44 <= var37) {
                                 ...
                                 int tBlockID = this.mBlockID;
                                 int tBlockMeta = this.mBlockMeta;
                                 byte x = 0;

                                 while(true) {
                                    if(x < this.mOreChances.length) {
                                       if(aRandom.nextInt(this.mOreChances[x]) != 0) {
                                          ++x;
                                          continue;
                                       }

                                       tBlockID = this.mOreIDs[x];
                                       tBlockMeta = this.mOreMetas[x];
                                    }
                                    ...
                                    if(var39 * var39 + var42 * var42 + var45 * var45 < 1.0D && (this.mAllowToGenerateinVoid && aWorld.func_72798_a(var38, var41, var44) == 0 || block != null && (block.isGenMineableReplaceable(aWorld, var38, var41, var44, Block.field_71981_t.field_71990_ca) || block.isGenMineableReplaceable(aWorld, var38, var41, var44, Block.field_72082_bJ.field_71990_ca) || block.isGenMineableReplaceable(aWorld, var38, var41, var44, Block.field_72012_bb.field_71990_ca)))) {
                                       aWorld.func_72832_d(var38, var41, var44, tBlockID, tBlockMeta, 0);
                                    }
