   ...
   public boolean executeCavegen(World aWorld, Random aRandom, String aBiome, int aDimensionType, int aChunkX, int aChunkZ, IChunkProvider aChunkGenerator, IChunkProvider aChunkProvider) {
      if(aDimensionType == this.mDimensionType && (this.mBiomeList.isEmpty() || this.mBiomeList.contains(aBiome)) && (this.mProbability <= 1 || aRandom.nextInt(this.mProbability) == 0)) {
         for(int i = 0; i < this.mAmount; ++i) {
            ...
            if((this.mAllowToGenerateinVoid && aWorld.func_72798_a(tX, tY, tZ) == 0 || tBlock != null && (tBlock.isGenMineableReplaceable(aWorld, tX, tY, tZ, Block.field_71981_t.field_71990_ca) || tBlock.isGenMineableReplaceable(aWorld, tX, tY, tZ, Block.field_72082_bJ.field_71990_ca) || tBlock.isGenMineableReplaceable(aWorld, tX, tY, tZ, Block.field_72012_bb.field_71990_ca))) && (aWorld.func_72798_a(tX, tY + 1, tZ) == Block.field_71938_D.field_71990_ca || aWorld.func_72798_a(tX, tY, tZ) == Block.field_71944_C.field_71990_ca)) {
