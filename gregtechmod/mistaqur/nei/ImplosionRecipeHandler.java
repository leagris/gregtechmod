...
public class ImplosionRecipeHandler extends GT_RecipeHandler {
   ...
   public void loadTransferRects() {
      try {
         ...
         e.add(GT_GUIContainer_ImplosionCompressor.class);
   ...
   public String getGuiTexture() {
      return "gregtech_addon:textures/gui/NEIImplosion.png";
   }
   ...
   public GT_RecipeHandler.CachedGT_Recipe getRecipe(GT_Recipe irecipe) {
      return new ImplosionRecipeHandler.CachedImplosionRecipe(irecipe);
   }

   public void drawExtras(int recipe) {
      Integer time = Integer.valueOf(((ImplosionRecipeHandler.CachedImplosionRecipe)this.arecipes.get(recipe)).mDuration);
      drawText(30, 80, "EU: " + GT_Utility.parseNumberToString(time.intValue() * ((ImplosionRecipeHandler.CachedImplosionRecipe)this.arecipes.get(recipe)).mEUt), -16777216);
      drawText(30, 90, "Time: " + GT_Utility.parseNumberToString(time.intValue() / 20) + " secs", -16777216);
      drawText(30, 100, "MaxEnergy: " + GT_Utility.parseNumberToString(((ImplosionRecipeHandler.CachedImplosionRecipe)this.arecipes.get(recipe)).mEUt) + " EU/t", -16777216);
   }

   public class CachedImplosionRecipe extends GT_RecipeHandler.CachedGT_Recipe {
