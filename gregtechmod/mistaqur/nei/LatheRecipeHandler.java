...
public class LatheRecipeHandler extends GT_RecipeHandler {
   ...
   public void loadTransferRects() {
      try {
         ...
         e.add(GT_GUIContainer_BasicMachine_Lathe.class);
   ...
   public String getGuiTexture() {
      return "gregtech_addon:textures/gui/NEILathe.png";
   }
   ...
   public GT_RecipeHandler.CachedGT_Recipe getRecipe(GT_Recipe irecipe) {
      return new LatheRecipeHandler.CachedLatheRecipe(irecipe);
   }

   public void drawExtras(int recipe) {
      Integer time = Integer.valueOf(((LatheRecipeHandler.CachedLatheRecipe)this.arecipes.get(recipe)).mDuration);
      drawText(30, 80, "EU: " + GT_Utility.parseNumberToString(time.intValue() * ((LatheRecipeHandler.CachedLatheRecipe)this.arecipes.get(recipe)).mEUt), -16777216);
      drawText(30, 90, "Time: " + GT_Utility.parseNumberToString(time.intValue() / 20) + " secs", -16777216);
      drawText(30, 100, "MaxEnergy: " + GT_Utility.parseNumberToString(((LatheRecipeHandler.CachedLatheRecipe)this.arecipes.get(recipe)).mEUt) + " EU/t", -16777216);
   }

   public class CachedLatheRecipe extends GT_RecipeHandler.CachedGT_Recipe {
