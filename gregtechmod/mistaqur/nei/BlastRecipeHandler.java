...
public class BlastRecipeHandler extends GT_RecipeHandler {
   ...
   public void loadTransferRects() {
      try {
         ...
         e.add(GT_GUIContainer_BlastFurnace.class);
   ...
   public String getGuiTexture() {
      return "gregtech_addon:textures/gui/NEIBlast.png";
   }
   ...
   public GT_RecipeHandler.CachedGT_Recipe getRecipe(GT_Recipe irecipe) {
      return new BlastRecipeHandler.CachedBlastRecipe(irecipe);
   }

   public void drawExtras(int recipe) {
      Integer time = Integer.valueOf(((BlastRecipeHandler.CachedBlastRecipe)this.arecipes.get(recipe)).mDuration);
      drawText(30, 80, "EU: " + GT_Utility.parseNumberToString(time.intValue() * ((BlastRecipeHandler.CachedBlastRecipe)this.arecipes.get(recipe)).mEUt), -16777216);
      drawText(30, 90, "Time: " + GT_Utility.parseNumberToString(time.intValue() / 20) + " secs", -16777216);
      drawText(30, 100, "MaxEnergy: " + GT_Utility.parseNumberToString(((BlastRecipeHandler.CachedBlastRecipe)this.arecipes.get(recipe)).mEUt) + " EU/t", -16777216);
      drawText(30, 110, "Heat Capacity: " + GT_Utility.parseNumberToString(((BlastRecipeHandler.CachedBlastRecipe)this.arecipes.get(recipe)).mStartEU) + " K", -16777216);
   }

   public class CachedBlastRecipe extends GT_RecipeHandler.CachedGT_Recipe {
